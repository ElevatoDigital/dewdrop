...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_summernote_webpack__ = __webpack_require__(173);
...
(function (factory) {
  ...
  var isSupportAmd = "function" === 'function' && __webpack_require__(174);
  ...
  if (agent.hasCodeMirror) {
    if (agent.isSupportAmd) {
      new Promise(function(resolve) { resolve(); }).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(140)]; (function (cm) {
        CodeMirror = cm;
