        ...
        $(document).on(
            ...
            function (e) {
                ...
                if ('block' === well.css('display')) {
                    Velocity(well, 'slideUp');
                } else {
                    Velocity(well, 'slideDown');
                ...
                decorator.data('save-action'),
                {
                    ...
                    success: function (response) {
                        ...
                        if (!response.result || 'error' === response.result) {
                            ...
                            Velocity(decorator, 'callout.shake');
            ...
            $.ajax(
                {
                    ...
                    success: function (response) {
                        ...
                        Velocity(decorator.find('.well:first'), 'slideUp');
                    }
                }
            );
        };
...
export default OptionInputDecorator;
