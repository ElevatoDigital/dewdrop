...
class TableTest extends BaseTestCase
{
     ...
     */
    public function testOmittingFieldsArgumentThrowsException()
    {
        $this->view->table('not an instance of Fields');
    }

    /**
     * @expectedException \Dewdrop\Exception
     */
    public function testOmittingArrayArgumentThrowsException()
    {
        $this->view->table($this->fields, null);
    }
