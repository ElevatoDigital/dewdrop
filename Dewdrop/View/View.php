...
class View
{
    ...
    private $helperClasses = array(
        'activitylogentity'          => '\Dewdrop\View\Helper\ActivityLogEntity',
        'activitylogmessage'         => '\Dewdrop\View\Helper\ActivityLogMessage',
        'activityloguserinformation' => '\Dewdrop\View\Helper\ActivityLogUserInformation',
